...
fastText_vocab, fastText_model = fastText.create_embeddings(embedding_sent_text,
...
fastText_pvocab, fastText_pmodel = fastText.create_embeddings(embedding_pos_text,
...
fastText_cvocab, fastText_cmodel = fastText.create_embeddings(embedding_char_text,
...
fastText_jvocab, fastText_jmodel = fastText.create_embeddings(embedding_jamo_text,
