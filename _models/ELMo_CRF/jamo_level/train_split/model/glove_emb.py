...
model_save_file_path = absolute_path + '_save/Elmo-CRF/jamo_level/train_split/model/glove_emb/'
data_save_file_path = absolute_path + '_save/Elmo-CRF/jamo_level/train_split/data/glove_emb/'
