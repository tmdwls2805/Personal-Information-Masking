...
model_save_file_path = absolute_path + '_save/Elmo-CRF/word_level/train_split/model/fastText_emb/'
data_save_file_path = absolute_path + '_save/Elmo-CRF/word_level/train_split/data/fastText_emb/'
