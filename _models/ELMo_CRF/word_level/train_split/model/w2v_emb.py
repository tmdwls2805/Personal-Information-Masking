# Word-Level, elmo, w2v_emb, POS 사용 모델
# Word와 POS Tag 중 word만 w2v embedding 수행하고, pos tag는 index embedding한 모델
...
model_save_file_path = absolute_path + '_save/Elmo-CRF/word_level/train_split/model/w2v_emb/'
data_save_file_path = absolute_path + '_save/Elmo-CRF/word_level/train_split/data/w2v_emb/'
