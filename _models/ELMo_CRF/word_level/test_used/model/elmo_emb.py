...
testData = config.training_data
test_data_path = input_path + testData

# 모델, weight, 데이터 저장 파일 경로
model_save_file_path = absolute_path + '_save/Elmo-CRF/word_level/test_used/model/elmo_emb/'
data_save_file_path = absolute_path + '_save/Elmo-CRF/word_level/test_used/data/elmo_emb/'
