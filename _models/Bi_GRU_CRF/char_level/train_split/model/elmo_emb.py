...
model_save_file_path = absolute_path + '_save/Bi-GRU-CRF/char_level/train_split/model/elmo_emb/'
data_save_file_path = absolute_path + '_save/Bi-GRU-CRF/char_level/train_split/data/elmo_emb/'
