# Char-Level, Bi-GRU, fastText_emb POS 사용 모델 (exobrain test-data 사용하여 평가)
...
model_save_file_path = absolute_path + '_save/Bi-GRU-CRF/char_level/test_used/model/fastText_emb/'
data_save_file_path = absolute_path + '_save/Bi-GRU-CRF/char_level/test_used/data/fastText_emb/'
