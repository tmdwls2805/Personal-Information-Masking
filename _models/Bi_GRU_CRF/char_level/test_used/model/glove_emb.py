# Char-Level, Bi-GRU, glove_emb POS 사용 모델 (exobrain test-data 사용하여 평가)
...
model_save_file_path = absolute_path + '_save/Bi-GRU-CRF/char_level/test_used/model/glove_emb/'
data_save_file_path = absolute_path + '_save/Bi-GRU-CRF/char_level/test_used/data/glove_emb/'
