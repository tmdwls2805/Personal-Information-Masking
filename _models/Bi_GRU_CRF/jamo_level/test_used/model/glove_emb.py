...
model_save_file_path = absolute_path + '_save/Bi-GRU-CRF/jamo_level/test_used/model/glove_emb/'
data_save_file_path = absolute_path + '_save/Bi-GRU-CRF/jamo_level/test_used/data/glove_emb/'
