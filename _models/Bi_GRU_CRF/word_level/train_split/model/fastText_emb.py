...
model_save_path = absolute_path + '_save/Bi-GRU-CRF/word_level/train_split/model/fastText_emb/'
data_save_path = absolute_path + '_save/Bi-GRU-CRF/word_level/train_split/data/fastText_emb/'
embedding_save_path = absolute_path + '_save/embeddings/' + inputData +  '/fastText_emb/'
model_save = model_save_path + inputData + '/' + inputData + '_' + str(epochs) + '_fastText_emb.json'
model_save_weights = model_save_path + inputData + '/' + inputData + '_' + str(epochs) + '_fastText_emb.h5'
...
pos_embed = Embedding(POS_VOCAB, output_dim=EMBEDDING_SIZE, input_length=max_len, name='pos_embedding',
...
print("\n", report)
classification_report_to_txt(epochs, "fastText", data_name, "../result/", report)
