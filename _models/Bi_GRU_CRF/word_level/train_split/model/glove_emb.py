...
model_save_path = absolute_path + '_save/Bi-GRU-CRF/word_level/train_split/model/glove_emb/'
data_save_path = absolute_path + '_save/Bi-GRU-CRF/word_level/train_split/data/glove_emb/'
...
from keras.layers import concatenate, GRU, Embedding, Dense, TimeDistributed, Bidirectional, Dropout, SpatialDropout1D
...
print("\n", report)
classification_report_to_txt(epochs, "glove", data_name, "../result/", report)
