...
def bigru_crf_word_pred(absolute_path, train_method, model_name, level, emb, txt):
    ...
    model_save_file_path = absolute_path + '_save/Bi-GRU-CRF/word_level/' + train_method + '/model/'+ emb +'/'
    data_save_file_path = absolute_path + '_save/Bi-GRU-CRF/word_level/' + train_method + '/data/'+ emb +'/'
