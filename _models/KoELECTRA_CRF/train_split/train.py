...
from _embeddingModels.koelectra.network import KoElectraCRF
from _embeddingModels.koelectra.data_processing import generate_training_data
from _embeddingModels.koelectra.trainer import Trainer
...
if __name__ == "__main__":
    ...
    # tokenizer load
    tokenizer = get_tokenizer() # base v2
    ...
    model = KoElectraCRF(config, num_labels=len(vocab)) # base-v2
