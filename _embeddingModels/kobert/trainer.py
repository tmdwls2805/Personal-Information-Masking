...
class Trainer:
    ...
    def train(self):
        ...
        for epochs in trange(epoch, desc="Epoch"):
            ...
            if epochs == epoch:
                ...
                # output_dict --> dictionary 형태로 return
    ...
    # 훈련된 model 저장하는 함수
    def save_model(self):
        torch.save(self.model, './model/kobert-{}_{}_{}.pth'.format(self.config.model_name, self.config.epochs, self.config.data_name))
